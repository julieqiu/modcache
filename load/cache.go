...
func CachedImport(ctx *build.Context, path, srcDir string, mode build.ImportMode) (*build.Package, error) {
	...
	return cachedImportDir(ctx, p.Dir, mode&^build.IgnoreVendor)
}
...
func cachedImportDir(ctx *build.Context, dir string, mode build.ImportMode) (*build.Package, error) {
